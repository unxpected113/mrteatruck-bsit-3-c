    ...
    <div class="bg-white" id="sidebar-wrapper">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    ...
                    <a href="<?php echo SITEURL;?>admin/add-category1.php" class="btn-add">Add Category</a>
                        <br><br>
                        <?php
        ...
        ?>
                    ...
                    while($row=mysqli_fetch_assoc($res))
                    {
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo SITEURL;?>admin/update-category1.php?id=<?php echo $id; ?>" class="btn-update">Update Category</a>
                ...
                else
                {
                    ?>
                    <tr>
                    <td colspan="6"><div classs="error">No Category Added.</div></td>
                    </tr>
                    <?php
                }
            ?>
